...
|----------|-----------|--------|--------|-------------|
| rust | `rust.ai_signals.commented_out_code` | Human | 2.5 | 2+ lines of commented-out code |
| rust | `rust_cst.complexity.low` | Claude | 2.5 | Low avg cyclomatic complexity (≤2.0) — simple, linear functions |
| rust | `rust.ai_signals.all_fns_documented` | Claude | 2.0 | Every function has a doc comment — suspiciously thorough |
| rust | `rust.comments.teaching_voice` | Claude | 2.0 | 3+ comments with teaching/explanatory voice |
| rust | `rust.comments.terse_markers` | Human | 2.0 | 2+ terse/frustrated comments (TODO, HACK, etc.) |
| python | `python.ai_signals.commented_out_code` | Human | 2.5 | 2+ lines of commented-out code |
| python | `python.ai_signals.all_fns_documented` | Claude | 2.0 | Every function has a docstring — suspiciously thorough |
| python | `python.comments.teaching_voice` | Claude | 2.0 | 3+ comments with teaching/explanatory voice |
...
| javascript | `js.ai_signals.commented_out_code` | Human | 2.5 | 2+ lines of commented-out code |
| javascript | `js.ai_signals.console_log` | Human | 2.0 | 3+ console.log calls — likely debugging artifacts |
| javascript | `js.comments.teaching_voice` | Claude | 2.0 | 3+ comments with teaching/explanatory voice |
...
| go | `go.ai_signals.commented_out_code` | Human | 2.5 | 2+ lines of commented-out code |
| go | `go.ai_signals.all_exported_documented` | Claude | 2.0 | All exported identifiers have doc comments |
| go | `go.comments.teaching_voice` | Claude | 2.0 | 3+ comments with teaching/explanatory voice |
